...
void PriorityQueue::Transaction::Push(
  ...
  TRACE_EVENT0("dorsal", "PriorityQueue::Transaction::Push");
  outer_queue_->container_.emplace(std::move(sequence), sequence_sort_key);
  TRACE_EVENT0("dorsal", "PriorityQueue::Transaction::Push_END");
}

const SequenceSortKey& PriorityQueue::Transaction::PeekSortKey() const {
  TRACE_EVENT0("dorsal", "PriorityQueue::Transaction::PeekSortKey");
  DCHECK(!IsEmpty());
  TRACE_EVENT0("dorsal", "PriorityQueue::Transaction::PeekSortKey_END");
  return outer_queue_->container_.top().sort_key();
}

scoped_refptr<Sequence> PriorityQueue::Transaction::PopSequence() {
  TRACE_EVENT0("dorsal", "PriorityQueue::Transaction::PopSequence");
  DCHECK(!IsEmpty());
  ...
  TRACE_EVENT0("dorsal", "PriorityQueue::Transaction::PopSequence_END");
  return sequence;
  TRACE_EVENT0("dorsal", "PriorityQueue::Transaction::PopSequence_END");
}

bool PriorityQueue::Transaction::IsEmpty() const {
  TRACE_EVENT0("dorsal", "PriorityQueue::Transaction::IsEmpty");
  bool temp;
  temp = outer_queue_->container_.empty();
  TRACE_EVENT0("dorsal", "PriorityQueue::Transaction::IsEmpty_END");
  return temp;
...
size_t PriorityQueue::Transaction::Size() const {
  TRACE_EVENT0("dorsal", "PriorityQueue::Transaction::Size");
  bool temp;
  temp = outer_queue_->container_.size();
  TRACE_EVENT0("dorsal", "PriorityQueue::Transaction::Size_END");
  return temp;
