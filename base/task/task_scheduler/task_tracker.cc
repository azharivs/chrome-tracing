...
scoped_refptr<Sequence> TaskTracker::RunAndPopNextTask(
    scoped_refptr<Sequence> sequence,
    CanScheduleSequenceObserver* observer) {
  TRACE_EVENT0("dorsal", "TaskTracker::RunAndPopNextTask");
  DCHECK(sequence);
...
// Majid end
  ...
  TRACE_EVENT0("dorsal", "TaskTracker::RunAndPopNextTask_END");
...
void TaskTracker::RunOrSkipTask(Task task,
  ...
  TRACE_EVENT0("dorsal", "TaskTracker::RunTask_END");
}
...
bool TaskTracker::BeforeRunTask(TaskShutdownBehavior shutdown_behavior) {
  TRACE_EVENT0("dorsal", "TaskTracker::BeforeRunTask");
  ...
  TRACE_EVENT0("dorsal", "TaskTracker::BeforeRunTask_END");
      return true;
    }
...
void TaskTracker::AfterRunTask(TaskShutdownBehavior shutdown_behavior) {
  TRACE_EVENT0("dorsal", "TaskTracker::AfterRunTask");
  if (shutdown_behavior == TaskShutdownBehavior::BLOCK_SHUTDOWN ||
  ...
  TRACE_EVENT0("dorsal", "TaskTracker::AfterRunTask_END");
}
