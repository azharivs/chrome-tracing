...
void SequenceManagerImpl::BindToCurrentThread() {
  TRACE_EVENT0("dorsal", "SequenceManagerImpl::BindToCurrentThread");
  associated_thread_->BindToCurrentThread();
  TRACE_EVENT0("dorsal", "SequenceManagerImpl::BindToCurrentThread_END");
}

void SequenceManagerImpl::CompleteInitializationOnBoundThread() {
  TRACE_EVENT0("dorsal", "SequenceManagerImpl::CompleteInitializationOnBoundThread");
  controller_->AddNestingObserver(this);
  TRACE_EVENT0("dorsal", "SequenceManagerImpl::CompleteInitializationOnBoundThread_END");
}
...
bool SequenceManagerImpl::AddToIncomingImmediateWorkList(
  ...
  TRACE_EVENT0("dorsal", "SequenceManagerImpl::AddToIncomingImmediateWorkList");
  ...
  TRACE_EVENT0("dorsal", "SequenceManagerImpl::AddToIncomingImmediateWorkList_END");
    return false;}
...
void SequenceManagerImpl::RemoveFromIncomingImmediateWorkList(
    internal::TaskQueueImpl* task_queue) {
  TRACE_EVENT0("dorsal", "SequenceManagerImpl::RemoveFromIncomingImmediateWorkList");
  AutoLock lock(any_thread_lock_);
  ...
  TRACE_EVENT0("dorsal", "SequenceManagerImpl::RemoveFromIncomingImmediateWorkList_END");
}
...
void SequenceManagerImpl::OnBeginNestedRunLoop() {
  TRACE_EVENT0("dorsal", "SequenceManagerImpl::OnBeginNestedRunLoop");
  main_thread_only().nesting_depth++;
  if (main_thread_only().observer)
    main_thread_only().observer->OnBeginNestedRunLoop();
  TRACE_EVENT0("dorsal", "SequenceManagerImpl::OnBeginNestedRunLoop_END");
}

void SequenceManagerImpl::OnExitNestedRunLoop() {
  TRACE_EVENT0("dorsal", "SequenceManagerImpl::OnExitNestedRunLoop");
  main_thread_only().nesting_depth--;
  ...
  TRACE_EVENT0("dorsal", "SequenceManagerImpl::OnExitNestedRunLoop_END");
}
...
void SequenceManagerImpl::OnQueueHasIncomingImmediateWork(
  ...
  TRACE_EVENT0("dorsal", "SequenceManagerImpl::OnQueueHasIncomingImmediateWork");
  if (AddToIncomingImmediateWorkList(queue, enqueue_order) && !queue_is_blocked)
    controller_->ScheduleWork();
  TRACE_EVENT0("dorsal", "SequenceManagerImpl::OnQueueHasIncomingImmediateWork_END");
}

void SequenceManagerImpl::MaybeScheduleImmediateWork(
    const Location& from_here) {
  TRACE_EVENT0("dorsal", "SequenceManagerImpl::MaybeScheduleImmediateWork");
  controller_->ScheduleWork();
  TRACE_EVENT0("dorsal", "SequenceManagerImpl::MaybeScheduleImmediateWork_END");
}
