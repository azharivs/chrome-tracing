...
// Majid start
	...
	void (*tp_ptr)(/*int, int,*/ char&, char*, char*, char*, unsigned long long, int, char*, const unsigned long long, unsigned int);
        char *error;
        ...
        *(void **) (&tp_ptr) = dlsym(tppHandle, "_Z19trpoint_jsontolttngPcS_S_S_yiS_yj");
	...
	(*tp_ptr)(/*(int) num_args, (int) tid, */(char&) phase, (char*) category_group_enabled, (char*) name, (char*) scope, (unsigned long long) id, (int) num_args, (char*) arg_types, (const unsigned long long) arg_values, (unsigned int) flags);
