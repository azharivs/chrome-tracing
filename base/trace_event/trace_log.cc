...
TraceEventHandle TraceLog::AddTraceEventWithThreadIdAndTimestamp(
  ...
  //sva added for LttngExport
  TraceEventLttngExport::AddLttngEvent(phase, category_group_enabled, name, id,
                                num_args, arg_names, arg_types, arg_values,
                                convertable_values);
...
void TraceLog::UpdateTraceEventDurationExplicit(
  ...
  // sva: Generate an Lttng event that marks the end of a complete event.
  TraceEventLttngExport::AddLttngCompleteEndEvent(name);
